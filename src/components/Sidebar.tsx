    ...
    <div className={`h-full transition-all duration-300 ${
      ...
      <div className={`h-full border-r bg-sidebar overflow-hidden flex flex-col ${
        ...
        <div className="flex items-center gap-2 p-4">
          <div className="h-7 w-7 bg-primary/20 rounded-md flex items-center justify-center">
            ...
            {conversations.map((conversation) => (
              ...
              >
                <Button
                  ...
                  className={cn(
                    "w-full justify-start text-sm font-normal truncate pr-8 relative py-2.5", 
        ...
        {/* Footer Actions */}
        <div className="mt-auto px-4 pb-6 pt-2 space-y-2">
          <Button 
            variant="outline" 
            size="sm" 
          ...
          <Button 
            variant="outline" 
            size="sm" 
            className="w-full justify-start text-destructive hover:bg-destructive/10 py-2.5"
